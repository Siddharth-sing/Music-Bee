...
question(
    '(Alan|) what (can|) this app (can|) do?', 
    '(Alan|) what does this app do?',
    '(Alan|) what is the working of this app',
    reply('Hey, I am Alan, your AI assistant created by Sid and this is a radio app where you can ask me to play some music. Start with hey Alan then say play some (pop|rock|hip hop|classic|spiritual) music' ),                              
